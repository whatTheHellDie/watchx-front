...
const messagesSlice = createSlice({
  ...
  reducers: {
    ...
    warning(state, action: PayloadAction<string>) {
      createMessage(state, 'warning', 'Warning', action.payload);
    },
    ...
    success(state, action: PayloadAction<string>) {
      createMessage(state, 'success', 'successfully', action.payload);
    },
    // Closes a message
...
export const { error, warning, info, success, close, handle_obsolete } =
